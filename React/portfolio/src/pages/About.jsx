  ...
  return (
    <div className="about container">
      ...
      >
        <h2>About Me</h2>
        <p>
          I'm a 16-year-old developer from Addis Ababa,Ethiopia focused on building clean,
        ...
        <div className="about__stats">
          ...
          <div><span className="num">-</span><span>Happy Clients</span></div>
          <div><span className="num">1+</span><span>Years Learning</span></div>
        </div>
