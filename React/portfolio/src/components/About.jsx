    ...
    <div className="about container">
      ...
      >
        ...
        <p>
          ...
          with a strong taste for Apple-style minimal design.
        </p>
        <div className="about__stats">
          <div><span className="num">20+</span><span>Projects</span></div>
          <div><span className="num">10+</span><span>Happy Clients</span></div>
          <div><span className="num">3+</span><span>Years Learning</span></div>
        </div>
